...
anim = animation.FuncAnimation(fig, animate_simple, frames=total_frames, interval=40, blit=False)
anim.save('./generated_assets/animation1.gif', writer='imagemagick')